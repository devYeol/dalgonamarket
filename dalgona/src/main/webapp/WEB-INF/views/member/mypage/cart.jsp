		...
		<div>
         ...
         <div class="cart-container">
            ...
            <tbody>
               <tr class="payment-tr">
                  <td style="width:20%;">
                  <input class="check-input" type="checkbox" style="margin-top: 40;">
                     <a href="#" style="text-decoration: none;">
                        <img src="http://img3.tmon.kr/cdn4/deals/2022/02/15/5164313822/front_cd6a3_671t8.jpg" width="150" height="150" border="0" style="margin-left: 10"/>
                     </a>
                  </td>
                  <td style="width: 55%">
                     <a href="#" style="color: black; text-decoration: none; font-size: 17"><b>상품타이틀</b></a><br>
                     <div style="margin-top:5; font-size: 15px">오예오예 오예스~</div>
                     <div style="margin-top:5;">30,000원</div>
                     <div style="margin-top:5; font-size: 15px">08.11.목요일 배송도착 예정</div>
                  </td>
         ...
         <div class="allprice-container">
         	<div class="allrprice-content">
         		<div class="allprice-form">
         			...
         			<i>2,000</i>
         			원
         			<span  class="all-plus"><img src="/resources/images/mypage/img_equals.png" style="width:14;"></span>
         			총 주문금액
